...
const produtos = [
    { nome: 'Caldinho de Feijão', barraca: 'Mineira', preco: 10.00 },
    { nome: 'Caldinho de Mandioca', barraca: 'Mineira', preco: 10.00 },
    { nome: 'Lanche de Pernil', barraca: 'Mineira', preco: 15.00 },
    { nome: 'Lanche de Pernil com Vinagrete', barraca: 'Mineira', preco: 18.00 },
    { nome: 'Milho Verde', barraca: 'Mineira', preco: 8.00 },
    { nome: 'Pamonha', barraca: 'Mineira', preco: 12.00 },
    { nome: 'Cural', barraca: 'Mineira', preco: 7.00 },
    { nome: 'Macarrão ao Sugo', barraca: 'Cantina Macarrão', preco: 20.00 },
    { nome: 'Macarrão à Bolonhesa', barraca: 'Cantina Macarrão', preco: 25.00 },
    { nome: 'Macarrão à Carbonara', barraca: 'Cantina Macarrão', preco: 27.00 },
    { nome: 'Macarrão ao Pesto', barraca: 'Cantina Macarrão', preco: 22.00 },
    { nome: 'Espetinho de Carne', barraca: 'Churrasco', preco: 12.00 },
    { nome: 'Espetinho de Linguiça', barraca: 'Churrasco', preco: 12.00 },
    { nome: 'Churrasco no Pão com Vinagrete', barraca: 'Churrasco', preco: 18.00 },
    { nome: 'Linguiça no Pão com Vinagrete', barraca: 'Churrasco', preco: 18.00 },
    { nome: 'Caldo Verde', barraca: 'Portuguesa', preco: 12.00 },
    { nome: 'Doce Português', barraca: 'Portuguesa', preco: 10.00 },
    { nome: 'Bolinho de Bacalhau', barraca: 'Portuguesa', preco: 15.00 },
    { nome: 'Porção de Linguiça tipo Alheira', barraca: 'Portuguesa', preco: 20.00 },
    { nome: 'Porção de Linguiça tipo Portuguesa', barraca: 'Portuguesa', preco: 20.00 },
    { nome: 'Vinho Tinto Seco', barraca: 'Portuguesa', preco: 12.00 },
    { nome: 'Vinho Tinto Suave', barraca: 'Portuguesa', preco: 12.00 },
    { nome: 'Frutas no Palito com Chocolate', barraca: 'Fruta', preco: 10.00 },
    { nome: 'Maçã do Amor', barraca: 'Fruta', preco: 8.00 },
    { nome: 'Salada de Frutas', barraca: 'Fruta', preco: 7.00 },
    { nome: 'Suco Natural de Laranja', barraca: 'Fruta', preco: 6.00 },
    { nome: 'Refrigerante 350ml', barraca: 'Bar', preco: 6.00 },
    { nome: 'Coca-Cola 350ml', barraca: 'Bar', preco: 6.00 },
    { nome: 'Coca-Cola Zero 350ml', barraca: 'Bar', preco: 6.00 },
    { nome: 'Guaraná Antartica 350ml', barraca: 'Bar', preco: 6.00 },
    { nome: 'Guaraná Antartica Zero 350ml', barraca: 'Bar', preco: 6.00 },
    { nome: 'Cerveja Heineken 350ml', barraca: 'Bar', preco: 8.00 },
    { nome: 'Cerveja Amstel 350ml', barraca: 'Bar', preco: 8.00 },
    { nome: 'H2O', barraca: 'Bar', preco: 5.00 },
    { nome: 'Suco', barraca: 'Bar', preco: 6.00 },
    { nome: 'Vinho Tinto', barraca: 'Bar', preco: 12.00 },
    { nome: 'Água Mineral Sem Gás', barraca: 'Bar', preco: 6.00 },
    { nome: 'Água Mineral Com Gás', barraca: 'Bar', preco: 6.00 },
];
